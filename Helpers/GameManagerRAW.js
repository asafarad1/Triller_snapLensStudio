...
// Public API
global.gameControllerRAW = {};

// Game State API
global.gameControllerRAW.sendSignal = function (signal) {
    stateMachine.sendSignal(signal);
};

global.gameControllerRAW.getCurrentStateName = function () {
    return stateMachine.currentState.name;
};

global.gameControllerRAW.addStateChangedCallback = function (callback) {
    stateChangedCallbacks.push(callback);
};

// Game Speed API
global.gameControllerRAW.getGameTime = function () {
    return time;
};

global.gameControllerRAW.getDeltaGameTime = function () {
    return deltaTime;
};

global.gameControllerRAW.getGameSpeed = function () {
    return timeSpeed;
};

global.gameControllerRAW.setGameSpeedNextFrame = setGameSpeed;
